            ...
            public void onItemClick(AdapterView<?> parent, final View view, final int position, final long id) {
                ...
                alert.setItems(arrayMenu, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        int groupIndex = cursor.getColumnIndex(DBHelper.LN_ID);
                        final int groupId = cursor.getInt(groupIndex);
                        cursor.close();
                        ...
                        if (which == 0) {
                            ...
                            intent.putExtra("nameLine", nameLine);
                            intent.putExtra("idLine", idLine);
                            intent.putExtra("nameGroup", ((TextView) view).getText().toString());
                        ...
                        if (which == 1) {
                            ...
                            builder4.setPositiveButton("ОК", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    Toast toast2 = Toast.makeText(getApplicationContext(),
                                            "Группа <" + ((TextView) view).getText() + "> удалена", Toast.LENGTH_SHORT);
                                    toast2.show();
                                }
                            });
                            ...
                            builder4.setMessage("Вы точно хотите удалить группу <" + ((TextView) view).getText() + ">?");
